...
export default function CFBSummaryTeamCard({
    ...
    return(
        ...
        <div className="m-8 lg:m-6 xl:mg-4 my-4 max-w-sm rounded-md overflow-hidden border hover:border-blue-100 min-w-[90%]  w-[100%] min-h-[84%]" >
            ...
            <div className="table-responsive px-2 py-2">
                <table className="min-w-[90%] w-[100%]  px-4 py-4 mb-4">
                    <thead>
                        <tr className="h-5">
