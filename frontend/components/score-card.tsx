    ...
    <div className="grid grid-flow-row auto-rows-auto">
      <div className="m-8 lg:m-6 xl:mg-4 my-4 max-w-3xl rounded-md overflow-hidden border hover:border-blue-100" >
        ...
        <div className="flex px-2 py-2 justify-between">
          {gameStatus === 'pre' ?
            <Button variant="outline" className="h-8 px-2 text-sm md:text-lg border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-gray-100">
              <Link href={`/cfb/game/${gameId}`}>Preview</Link>
            </Button> : (pbpAvailable ?
              <Button variant="outline" className="h-8 px-2 text-sm md:text-lg border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-gray-100">
                <a href={`/cfb/game/${gameId}`}>Stats</a>
              </Button> :
              <Button variant="outline" className="h-8 px-2 text-sm md:text-lg disabled border-blue-200 text-blue-200  hover:bg-none">
                Stats
              </Button>)}
          {broadcastName !== "" ?
            <Button variant="outline" className="h-8 px-2 text-sm md:text-lg border-gray-500 text-gray-500 hover:bg-gray-500 hover:text-gray-100">
