...
function PlayRow(play: CFBGameRow,
    ...
    return (
        <>
        <tr className="accordion-toggle" onClick={toggleExpanded}>
        ...
        {expanded ? (
            <tr className="flex justify-center w-11/12" >
                <td  className="flex w-11/12">
                    <div className="flex justify-center w-11/12" id={`play-${collapsePrefix}-${play.game_play_number}`}>
...
export default function CFBPlayTableOrig(
    {   plays,
        prefix,
        expandable,
        errorMsg,
